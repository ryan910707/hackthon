...
class LabelerWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # selcect folder
        self.headline_folder = QLabel('Select folder containing images you want to label', self)
    ...
    def waylon(self, img_path):
        return os.path.join(r'C:\Users\Kenneth Yang\Desktop\hackathon2022\hackthon\data\waylon.png')

    def tony(self, img_path):
        return os.path.join(r'C:\Users\Kenneth Yang\Desktop\hackathon2022\hackthon\data\tony.png')
